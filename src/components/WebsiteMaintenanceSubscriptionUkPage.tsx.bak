        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200">
              Keep your website stable, updated, measurable, and improving every month. Primewayz UK supports website updates,
              bug fixes, technical SEO checks, landing page improvements, analytics, and ongoing conversion-focused maintenance
          ...
          <div className="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/20 backdrop-blur">
            ...
            <div className="mt-5 space-y-4">
              {painPoints.map((item) => (
                <p key={item} className="rounded-2xl bg-white/10 p-4 text-sm leading-6 text-slate-100">
                  {item}
                </p>
              ))}
            </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-8 text-slate-600">
            The aim is not only to “keep the site running”. The aim is to keep the website useful, updated,
            technically healthy, and aligned with your lead-generation priorities.
          </p>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              Instead of waiting for one-off website tasks to become urgent, we help you maintain a clear monthly
      ...
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-3">
        <div className="rounded-3xl border border-slate-200 p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Best for UK SMEs that already have a live website and need consistent updates, checks, and improvements.
          </p>
        </div>
        <div className="rounded-3xl border border-slate-200 p-6">
          <h3 className="text-xl font-bold">For lead generation</h3>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Improve landing pages, contact forms, CTAs, tracking, technical SEO basics, and conversion journeys.
          </p>
        </div>
        <div className="rounded-3xl border border-slate-200 p-6">
          <h3 className="text-xl font-bold">For controlled support</h3>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Use a predictable monthly support model instead of scattered fixes, unclear ownership, or delayed changes.
          </p>
        </div>
      </div>
    </section>
