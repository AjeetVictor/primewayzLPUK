          ...
          <div className="grid lg:grid-cols-[0.88fr_1.12fr]">
            ...
            <form onSubmit={handleSubmit} noValidate className="p-6 sm:p-9 lg:p-12">
              ...
              <div className="mt-7 grid gap-5">
                <div>
                  <label htmlFor="audit-website-url" className="mb-2 block text-sm font-bold text-slate-800">Website URL *</label>
                  <input
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="audit-business-name" className="mb-2 block text-sm font-bold text-slate-800">Business name *</label>
                    <input
                  ...
                  <div>
                    <label htmlFor="audit-business-type" className="mb-2 block text-sm font-bold text-slate-800">Business type *</label>
                    <select
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="audit-country" className="mb-2 block text-sm font-bold text-slate-800">Target country *</label>
                    <input
                      id="audit-country"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="audit-location" className="mb-2 block text-sm font-bold text-slate-800">Location (optional)</label>
                    <input
                      id="audit-location"
                      type="text"
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="audit-phone" className="mb-2 block text-sm font-bold text-slate-800">Phone (optional)</label>
                    <input
                      id="audit-phone"
                      type="tel"
                      autoComplete="tel"
                  ...
                  <div>
                    <label htmlFor="audit-email" className="mb-2 block text-sm font-bold text-slate-800">Email (optional)</label>
                    <input
                      id="audit-email"
                      type="email"
                      autoComplete="email"
