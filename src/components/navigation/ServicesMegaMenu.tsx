...
const serviceRoutes: ServiceRoute[] = [
  {
    ...
    summary: 'Discovery, trust signals and enquiry journeys',
    href: '/website-visibility-support',
    icon: Globe2,
    tone: 'teal',
    badge: 'Popular',
    description:
      'Improve how your website is discovered, understood and used by prospective customers across technical search, page clarity, trust signals and conversion barriers.',
    checklist: [
      'Technical search foundations',
      'Page clarity & trust signals',
      'Enquiry journeys & tracking',
      'Content & service page clarity',
      'Conversion barrier fixes',
      'Search Console findings',
    ],
  },
  {
    title: 'CRM & Workflow Automation',
    summary: 'Enquiry capture, follow-up and reporting',
  ...
  },
  {
    ...
    tone: 'navy',
    description:
      'Build, improve, integrate or modernise business applications and digital products through structured, accountable software delivery.',
    checklist: [
      'Prioritised shared backlog',
      'Feature and product work',
  ...
  },
  {
    ...
    summary: 'Dependable additional delivery capacity',
    href: '/remote-it-resources',
    icon: Users,
    tone: 'blue',
    description:
      'Add experienced developers, QA professionals, analysts and project coordinators when your internal team needs dependable additional capacity.',
    checklist: [
      'Developers and QA',
      'Business analysis',
      ...
      'Delivery continuity',
      'Clear ownership',
      'UK working-hour overlap',
    ],
  },
  {
    title: 'Managed Application & Website Support',
    summary: 'Reliability, updates and continuity',
    href: '/maintenance',
    icon: ShieldCheck,
    tone: 'teal',
    description:
      'Maintain the reliability, security and performance of existing websites and applications through monitoring, fixes, updates and controlled improvements.',
    checklist: [
