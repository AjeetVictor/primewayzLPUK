...
const serviceRoutes: ServiceRoute[] = [
  ...
  },
  {
    ...
    summary: 'Monthly development capacity for continuous work',
    href: '/software-development-subscription-uk',
    icon: Code2,
    tone: 'navy',
    description:
      'Structured monthly software development capacity for ongoing improvements, integrations, fixes and feature work—without unlimited-development promises.',
    checklist: [
