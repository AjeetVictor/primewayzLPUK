    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-8 left-8 z-50 hidden p-4 bg-emerald-600 text-white rounded-full shadow-2xl shadow-emerald-900/40 hover:bg-emerald-500 transition-colors group sm:inline-flex"
