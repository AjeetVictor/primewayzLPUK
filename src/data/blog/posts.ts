...
export const posts: BlogPost[] = [
  {
    ...
    secondaryCategories: ['technical-seo', 'business-strategy'],
    tags: [
      'AI Content',
      'UK SMEs',
      'Digital Strategy',
  ...
  },
  {
    ...
    secondaryCategories: ['business-strategy'],
  ...
  },
  {
    ...
    primaryCategory: 'ai-automation',
    secondaryCategories: ['digital-transformation'],
  ...
  },
  {
    ...
    secondaryCategories: ['web-development', 'technical-seo'],
  ...
  },
  {
    ...
    category: 'UK SMEs',
    primaryCategory: 'software-support',
    secondaryCategories: ['software-development'],
  ...
  },
  {
    ...
    primaryCategory: 'digital-transformation',
    secondaryCategories: ['technical-seo', 'ai-automation'],
  ...
  },
  {
    ...
    secondaryCategories: ['software-development', 'business-strategy'],
