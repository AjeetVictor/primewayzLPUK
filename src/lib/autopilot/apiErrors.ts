...
export const AUTOPILOT_ERROR_CODES = {
  ...
  GSC_IDENTITY_REQUIRED: 'GSC_IDENTITY_REQUIRED',
  GSC_IDENTITY_INVALID: 'GSC_IDENTITY_INVALID',
  GSC_EMAIL_NOT_VERIFIED: 'GSC_EMAIL_NOT_VERIFIED',
  GSC_EMAIL_MISMATCH: 'GSC_EMAIL_MISMATCH',
  GSC_AUTHORIZATION_CANCELLED: 'GSC_AUTHORIZATION_CANCELLED',
  GSC_PROPERTY_NOT_ACCESSIBLE: 'GSC_PROPERTY_NOT_ACCESSIBLE',
  GSC_RECONNECT_FAILED: 'GSC_RECONNECT_FAILED',
  GA4_CONFIGURATION_REQUIRED: 'GA4_CONFIGURATION_REQUIRED',
  GA4_SYNC_IN_PROGRESS: 'GA4_SYNC_IN_PROGRESS',
  GA4_SYNC_FAILED: 'GA4_SYNC_FAILED',
